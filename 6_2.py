...
try:
  ...
  print "The auth file in %s does not exist. Please verify it is there." % args.file
  sys.exit(1)
except pyrax.exceptions.AuthenticationFailed:
  print "Unable to authenticate with the credentials found in %s. Please verify that they are correct." % args.file
  sys.exit(1)
